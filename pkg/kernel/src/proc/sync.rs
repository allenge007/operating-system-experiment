...
impl Semaphore {
    ...
    pub fn wait(&mut self, pid: ProcessId) -> SemaphoreResult {
        // DONE: if the count is 0, then push pid into the wait queue
        //          return Block(pid)
    ...
    pub fn signal(&mut self) -> SemaphoreResult {
        // DONE: if the wait queue is not empty
...
impl SemaphoreSet {
    pub fn insert(&mut self, key: u32, value: usize) -> bool {
        ...
        // DONE: insert a new semaphore into the sems
        //          use `insert(/* ... */).is_none()`
        self.sems.insert(
            SemaphoreId::new(key),
    ...
    pub fn remove(&mut self, key: u32) -> bool {
        ...
        // DONE: remove the semaphore from the sems
        //          use `remove(/* ... */).is_some()`
    ...
    pub fn wait(&self, key: u32, pid: ProcessId) -> SemaphoreResult {
        ...
        // DONE: try get the semaphore from the sems
